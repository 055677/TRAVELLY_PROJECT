...
def cost():
    try:
        ...
        # Convert num_children and num_days to integers
        num_children = int(request.json.get('num_children', 0))  # Default to 0 if not provided
        num_days = int(request.json.get('num_days', 0))  # Default to 0 if not provided
        ...
        if vacation_type == 'solo':
            ...
            base_cost = city_budget['Child_Budget']
        else:
